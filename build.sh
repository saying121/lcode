...
zip -j ./release/code-aarch64-apple-darwin.zip ./release/lcode-aarch64-apple-darwin
zip -j ./release/code-x86_64-apple-darwin.zip ./release/lcode-x86_64-apple-darwin
zip -j ./release/code-x86_64-unknown-linux-gnu.zip ./release/lcode-x86_64-unknown-linux-gnu
zip -j ./release/code-x86_64-pc-windows-gnu.zip ./release/lcode-x86_64-pc-windows-gnu.exe
